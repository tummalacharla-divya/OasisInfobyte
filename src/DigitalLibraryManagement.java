...
class DigitalLibraryManagement{
    HashMap<String,Integer> loginto = new HashMap<String, Integer>();
    ...
    public void admin_login()
    {
        ...
        loginto.put("divya",20001);
        loginto.put("tejaswini",20123);
    ...
    public void user_login()
    {
        ...
        loginto.put("divya",20001);
        loginto.put("tejaswini",20123);
        loginto.put("div",12345);
        loginto.put("tej",87654);
        loginto.put("luk",67832);
